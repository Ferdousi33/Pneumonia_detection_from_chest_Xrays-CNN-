...
Prior to any overfitting prevention techniques, the model was trained using a learning rate of o.oo1 and a batch size of 32. The training accuracy was high but validation accuracy was too low.The opposite case is seen in the loss curves indicating overfitting.
